                    ...
                    <div>
                        ...
                        <div class="pb-3">
                            ...
                            <input type="text" id="item_name" name="item_name"
                                value="{{ $item->item_name ?? old('item_name') }}"
                        ...
                        <div class="pb-3">
                            ...
                            <input type="text" name="price" value="{{ $item->price ?? old('price') }}"
                        ...
                        <div class="pb-3">
                            ...
                            <textarea id="editor" rows="4" name="description">{{ $item->description ?? old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="pb-3">
                            ...
                            <select name="item_condition" id="item_condition"
                                ...
                                <option value="new" {{ $item->item_condition === 'new' ? 'selected' : '' }}
                                    {{ old('item_condition') ? 'selected' : '' }}>New</option>
                                <option value="used" {{ $item->item_condition === 'used' ? 'selected' : '' }}
                                    {{ old('item_condition') ? 'selected' : '' }}>Used</option>
                                <option value="good second hand"
                                    {{ $item->item_condition === 'good second hand' ? 'selected' : '' }}
                                    {{ old('item_condition') ? 'selected' : '' }}>Good Second
                                    Hand</option>
                            </select>
                        ...
                        <div class="pb-3">
                            ...
                            <select name="item_type" id="item_type"
                                ...
                                <option value="sell" {{ $item->item_type === 'sell' ? 'selected' : '' }}
                                    {{ old('item_type') ? 'selected' : '' }}>For Sell</option>
                                <option value="buy" {{ $item->item_type === 'buy' ? 'selected' : '' }}
                                    {{ old('item_type') ? 'selected' : '' }}>For Buy</option>
                                <option value="exchange" {{ $item->item_type === 'exchange' ? 'selected' : '' }}
                                    {{ old('item_type') ? 'selected' : '' }}>For Exchange</option>
                            </select>
                            @error('item_type')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="pb-3">
                            ...
                            <input id="default-checkbox" type="checkbox" value="1" name="status"
                                {{ old('status') ? 'checked' : '' }} @if ($category->status) checked @endif
                    ...
                    <div>
                        ...
                        <div class="pb-3">
                            ...
                            <textarea id="address" rows="4" name="address"
                                ...
                                placeholder="Enter Address">{{ $item->address ?? old('address') }}</textarea>
                            @error('address')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="pb-3">
                            ...
                            <div class="grid gap-1 md:grid-cols-2">
                                <div>
                                    <input type="text" value="{{ $item->latitude ?? old('latitude') }}" readonly
                                ...
                                <div>
                                    <input type="text" value="{{ $item->longitude ?? old('longitude') }}" readonly
