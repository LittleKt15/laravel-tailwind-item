...
@section('content')
    <div class="container mx-auto">
        ...
        @if (Session('add'))
            <div id="alert-3" class="flex p-4 mb-3 text-green-800 rounded-lg bg-green-50 clear-both" role="alert">
        ...
        @if (Session('del'))
            <div id="alert-2" class="flex p-4 mb-3 text-red-800 rounded-lg bg-red-50" role="alert">
                <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                        ...
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-6 py-4">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <form action="{{ route('categories.update-status', $category->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <input type="checkbox" value="" class="sr-only peer"
                                            @if ($category->status === 1) checked @endif onchange="this.form.submit()">
                                        <div
